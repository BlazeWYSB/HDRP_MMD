...
//
#define DEBUGVIEW_AXF_BSDFDATA_IS_DEFERRED (1250)
#define DEBUGVIEW_AXF_BSDFDATA_MATERIAL_FEATURES (1251)
#define DEBUGVIEW_AXF_BSDFDATA_AMBIENT_OCCLUSION (1252)
#define DEBUGVIEW_AXF_BSDFDATA_SPECULAR_OCCLUSION (1253)
#define DEBUGVIEW_AXF_BSDFDATA_NORMAL_WS (1254)
#define DEBUGVIEW_AXF_BSDFDATA_NORMAL_VIEW_SPACE (1255)
#define DEBUGVIEW_AXF_BSDFDATA_TANGENT_WS (1256)
#define DEBUGVIEW_AXF_BSDFDATA_BITANGENT_WS (1257)
#define DEBUGVIEW_AXF_BSDFDATA_DIFFUSE_COLOR (1258)
#define DEBUGVIEW_AXF_BSDFDATA_SPECULAR_COLOR (1259)
#define DEBUGVIEW_AXF_BSDFDATA_FRESNEL0 (1260)
#define DEBUGVIEW_AXF_BSDFDATA_PERCEPTUAL_ROUGHNESS (1261)
#define DEBUGVIEW_AXF_BSDFDATA_ROUGHNESS (1262)
#define DEBUGVIEW_AXF_BSDFDATA_HEIGHT_MM (1263)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_UVZY (1264)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_UVXZ (1265)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_UVXY (1266)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_MIP_LEVEL_ZY (1267)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_MIP_LEVEL_XZ (1268)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_MIP_LEVEL_XY (1269)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_TRIPLANAR_WEIGHTS (1270)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_DDX_ZY (1271)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_DDY_ZY (1272)
#define DEBUGVIEW_AXF_BSDFDATA_FLAKES_DDX_XZ (1273)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        case DEBUGVIEW_AXF_BSDFDATA_IS_DEFERRED:
