...
//
#define DEBUGVIEW_EYE_BSDFDATA_IS_DEFERRED (1550)
#define DEBUGVIEW_EYE_BSDFDATA_MATERIAL_FEATURES (1551)
#define DEBUGVIEW_EYE_BSDFDATA_DIFFUSE_COLOR (1552)
#define DEBUGVIEW_EYE_BSDFDATA_FRESNEL0 (1553)
#define DEBUGVIEW_EYE_BSDFDATA_IOR (1554)
#define DEBUGVIEW_EYE_BSDFDATA_AMBIENT_OCCLUSION (1555)
#define DEBUGVIEW_EYE_BSDFDATA_SPECULAR_OCCLUSION (1556)
#define DEBUGVIEW_EYE_BSDFDATA_NORMAL_WS (1557)
#define DEBUGVIEW_EYE_BSDFDATA_NORMAL_VIEW_SPACE (1558)
#define DEBUGVIEW_EYE_BSDFDATA_DIFFUSE_NORMAL_WS (1559)
#define DEBUGVIEW_EYE_BSDFDATA_DIFFUSE_NORMAL_VIEW_SPACE (1560)
#define DEBUGVIEW_EYE_BSDFDATA_GEOMETRIC_NORMAL (1561)
#define DEBUGVIEW_EYE_BSDFDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1562)
#define DEBUGVIEW_EYE_BSDFDATA_PERCEPTUAL_ROUGHNESS (1563)
#define DEBUGVIEW_EYE_BSDFDATA_MASK (1564)
#define DEBUGVIEW_EYE_BSDFDATA_IRIS_PLANE_OFFSET (1565)
#define DEBUGVIEW_EYE_BSDFDATA_IRIS_RADIUS (1566)
#define DEBUGVIEW_EYE_BSDFDATA_CAUSTIC_INTENSITY (1567)
#define DEBUGVIEW_EYE_BSDFDATA_CAUSTIC_BLEND (1568)
#define DEBUGVIEW_EYE_BSDFDATA_DIFFUSION_PROFILE_INDEX (1569)
#define DEBUGVIEW_EYE_BSDFDATA_SUBSURFACE_MASK (1570)
#define DEBUGVIEW_EYE_BSDFDATA_ROUGHNESS (1571)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        case DEBUGVIEW_EYE_BSDFDATA_IS_DEFERRED:
