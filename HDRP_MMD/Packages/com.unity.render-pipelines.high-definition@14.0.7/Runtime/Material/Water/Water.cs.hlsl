...
//
#define DEBUGVIEW_WATER_BSDFDATA_IS_DEFERRED (1650)
#define DEBUGVIEW_WATER_BSDFDATA_MATERIAL_FEATURES (1651)
#define DEBUGVIEW_WATER_BSDFDATA_DIFFUSE_COLOR (1652)
#define DEBUGVIEW_WATER_BSDFDATA_FRESNEL0 (1653)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        case DEBUGVIEW_WATER_BSDFDATA_IS_DEFERRED:
