...
#define DEBUGVIEW_WATER_BSDFDATA_NORMAL_WS (1653)
#define DEBUGVIEW_WATER_BSDFDATA_NORMAL_VIEW_SPACE (1654)
#define DEBUGVIEW_WATER_BSDFDATA_LOW_FREQUENCY_NORMAL_WS (1655)
#define DEBUGVIEW_WATER_BSDFDATA_LOW_FREQUENCY_NORMAL_VIEW_SPACE (1656)
#define DEBUGVIEW_WATER_BSDFDATA_PERCEPTUAL_ROUGHNESS (1657)
#define DEBUGVIEW_WATER_BSDFDATA_ROUGHNESS (1658)
#define DEBUGVIEW_WATER_BSDFDATA_CAUSTICS (1659)
#define DEBUGVIEW_WATER_BSDFDATA_FOAM (1660)
