...
#define DEBUGVIEW_STACKLIT_BSDFDATA_IS_DEFERRED (1151)
#define DEBUGVIEW_STACKLIT_BSDFDATA_DIFFUSE_COLOR (1152)
#define DEBUGVIEW_STACKLIT_BSDFDATA_FRESNEL0 (1153)
#define DEBUGVIEW_STACKLIT_BSDFDATA_AMBIENT_OCCLUSION (1154)
#define DEBUGVIEW_STACKLIT_BSDFDATA_NORMAL_WS (1155)
#define DEBUGVIEW_STACKLIT_BSDFDATA_NORMAL_VIEW_SPACE (1156)
#define DEBUGVIEW_STACKLIT_BSDFDATA_GEOMETRIC_NORMAL (1157)
#define DEBUGVIEW_STACKLIT_BSDFDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1158)
#define DEBUGVIEW_STACKLIT_BSDFDATA_COAT_NORMAL (1159)
#define DEBUGVIEW_STACKLIT_BSDFDATA_COAT_NORMAL_VIEW_SPACE (1160)
#define DEBUGVIEW_STACKLIT_BSDFDATA_BENT_NORMAL (1161)
#define DEBUGVIEW_STACKLIT_BSDFDATA_BENT_NORMAL_VIEW_SPACE (1162)
#define DEBUGVIEW_STACKLIT_BSDFDATA_PERCEPTUAL_ROUGHNESS_A (1163)
#define DEBUGVIEW_STACKLIT_BSDFDATA_PERCEPTUAL_ROUGHNESS_B (1164)
#define DEBUGVIEW_STACKLIT_BSDFDATA_LOBE_MIX (1165)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        case DEBUGVIEW_STACKLIT_BSDFDATA_MATERIAL_FEATURES:
            ...
            break;
        case DEBUGVIEW_STACKLIT_BSDFDATA_IS_DEFERRED:
