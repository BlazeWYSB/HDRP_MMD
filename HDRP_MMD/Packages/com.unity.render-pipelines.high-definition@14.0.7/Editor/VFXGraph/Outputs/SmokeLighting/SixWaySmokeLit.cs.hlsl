...
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_IS_DEFERRED (1751)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_ABSORPTION_RANGE (1752)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_DIFFUSE_COLOR (1753)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_FRESNEL0 (1754)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_AMBIENT_OCCLUSION (1755)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_NORMAL_WS (1756)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_NORMAL_VIEW_SPACE (1757)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_TANGENT (1758)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_TANGENT_WORLD_SPACE (1759)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_GEOMETRIC_NORMAL (1760)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1761)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_RIG_RIGHT_TOP_BACK (1762)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_RIG_LEFT_BOTTOM_FRONT (1763)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BAKE_DIFFUSE_LIGHTING0 (1764)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BAKE_DIFFUSE_LIGHTING1 (1765)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BAKE_DIFFUSE_LIGHTING2 (1766)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BACK_BAKE_DIFFUSE_LIGHTING0 (1767)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BACK_BAKE_DIFFUSE_LIGHTING1 (1768)
#define DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_BACK_BAKE_DIFFUSE_LIGHTING2 (1769)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        case DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_MATERIAL_FEATURES:
            ...
            break;
        case DEBUGVIEW_SIXWAYSMOKELIT_BSDFDATA_IS_DEFERRED:
