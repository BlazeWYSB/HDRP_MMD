Shader "Blaze/Unlit/DissolveVFX"
{
    Properties
    {
        ...
        [Toggle(_DISSOLVE_ON)] _Dissolve("Is Enable Dissolve", Float) = 0.0
        [Toggle(_DISSOLVE_SOFT)] _DissolveSoft("Is Soft Dissolve", Float) = 0.0
        _PerturbMap("Perturb in xy", 2D) = "white" {}
        _DissolveMap("Dissolve in x", 2D) = "white" {}
        [Toggle(_PERTURB_ON)] _Perturb("Is Enable Perturb", Float) = 0.0
        _PerturbNoiseSpeedX("Perturb Noise Speed X", Float) = 0
        _PerturbNoiseSpeedY("Perturb Noise Speed Y", Float) = 0
        _PerturbRate("Perturb rate",  Range(0.0, 1.0)) = 1
        _DissolveRate("Dissolve Rate",  Range(0.0, 1.0)) = 0
        //
    ...
    #pragma shader_feature_local _DISSOLVE_SOFT
    #pragma shader_feature_local _PERTURB_ON
    //
    ...
    CustomEditor "Rendering.HighDefinition.UnlitVFXGUI"
}
